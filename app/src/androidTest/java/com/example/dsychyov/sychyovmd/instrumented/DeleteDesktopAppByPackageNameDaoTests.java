...
public class DeleteDesktopAppByPackageNameDaoTests {
    ...
    public static List<Object[]> data() {
        return Arrays.asList(
                ...
                new Object[] { DesktopApp.Type.CONTACT, 1 }
        );
    }
    ...
    public DeleteDesktopAppByPackageNameDaoTests(DesktopApp.Type input, int output) {
        mInput = input;
        mOutput = output;
    }

    @Test
    public void deleteDesktopAppByPackageName() {
        ...
        desktopAppDao.deleteDesktopAppByPackageNameAndUpdatePositions(desktopApp.value);
